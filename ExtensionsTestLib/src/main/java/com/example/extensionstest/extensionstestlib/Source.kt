...
interface Source {
    ...
    fun findAnimeInSource(animeInfo: Anime): List<SourceAnime>
    ...
    fun getEpisodeList(anime: SourceAnime): List<SourceEpisode>

    // retrieve the media stream (hls or video file) for the given episode
    fun getMediaStreamForEpisode(anime: SourceAnime, episode: SourceEpisode): MediaTrack?
}